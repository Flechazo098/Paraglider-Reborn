...
public class CosmeticRecipeBuilder {
	...
	public CosmeticRecipeBuilder addCriterion(String name, CriterionTriggerInstance criterionIn) {
		this.advancementBuilder.addCriterion(name, AdvancementGen.impossible());
		return this;
	}
	...
	public static class CosmeticRecipe implements Recipe<RecipeWrapper> {
		private final Item result;
		...
		@Override
		public @NotNull ItemStack assemble(@NotNull RecipeWrapper craftingInput, @NotNull net.minecraft.core.RegistryAccess registryAccess) {
