...
public final class ParagliderLoots{
	...
	public static final LootItemConditionType WITHER_DROPS_VESSEL = new LootItemConditionType(LootConditions.CODEC_WITHER_DROPS_VESSEL);
	public static final LootItemConditionType SPIRIT_ORB_LOOTS = new LootItemConditionType(LootConditions.CODEC_SPIRIT_ORB_LOOTS);
	public static final LootItemConditionType FEATURES_SPIRIT_ORBS = new LootItemConditionType(LootConditions.CODEC_FEATURES_SPIRIT_ORBS);

	public static final LootItemFunctionType SPAWNER_SPIRIT_ORB_COUNT = new LootItemFunctionType(LootFunctions.CODEC_SPAWNER_SPIRIT_ORB_COUNT);
